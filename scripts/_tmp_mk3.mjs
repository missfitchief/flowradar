...
await c.connect();
await c.query(`SELECT pg_terminate_backend(pid) FROM pg_stat_activity WHERE datname='flowradar_pilot' AND pid <> pg_backend_pid()`);
...
console.log('pilot DB recreated');
await c.end();
