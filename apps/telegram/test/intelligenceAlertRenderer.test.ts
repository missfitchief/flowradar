  ...
  it('renders an explainable compact alert with all drill-down actions', () => {
    const rendered = renderIntelligenceAlert({
      ...
      signal: {
        ...
        scoreDecompositionJson: { entityConfluence: { raw: 1, weight: 24, contribution: 24, explanation: '2 entities' } },
    ...
    expect(labels).toEqual(expect.arrayContaining(['Evidence', 'Why this signal', 'Full entity history', 'Outcome tracking']));
